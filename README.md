...
Everything from New Bank must be checked instead of assuming it's true. Impressions of attitude from admin and GTD staff suggests it's pretty normal to "try to make a bad situation look better than it is". Have asked Healthwatch Manchester for advice and will update if any is received.
