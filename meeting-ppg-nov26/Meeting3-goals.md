...
* **No message portal/progress:** people cannot see status, can`t re-read a call, do not know what happens next.
...
- So-called 'Efficiency' getting in the way of people solving problems until they become bigger problems. 
