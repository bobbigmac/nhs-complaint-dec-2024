...
- Google review coverage rows: 75
- Google Maps direct coverage rows: 66
- Review text files written: 61
- Google Maps scans completed: 89
- Google Maps manual review queue: 20
