      ...
      <div class="service-finder-header">
        ...
        <div class="service-finder-actions">
          ...
          <div class="service-finder-radius-control">
            <div class="service-finder-radius-copy">
              <label for="service-finder-out-of-area-miles">Out-of-area range</label>
              <span>Include willing nearby practices within this distance.</span>
            </div>
            <div class="service-finder-radius-stepper">
              ...
              <span class="service-finder-radius-unit">miles</span>
            </div>
          </div>
        </div>
      </div>
