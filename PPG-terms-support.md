...
# PPG Terms - Supporting Research and Notes

Mostly wall of text with some useful information, supports [PPG-terms-review.md](./PPG-terms-review.md), which should be read first.
...
> [!IMPORTANT]
> The following sections were initially drafted with the assistance of AI tools (all sources fully cited and reviewed) and then revised by hand. While the focus may wander at times, many of the points raised are relevant, and the resources listed toward the end may be particularly helpful.
