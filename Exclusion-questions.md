...
* What *is* the complaints process at this practice since the takeover? What complaints are there a lot (if any), and if none why not? What complaints are *not* there because it would seem pointless to complain about if nothing would change? How many complaints does this practice recieve, and how are they usually resolved? 
