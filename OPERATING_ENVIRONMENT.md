# Operating Environment Around GTD
...
1. Do not treat every organisation near GTD as a direct competitor.
2. Do not treat every federation as a management company.
3. Do not treat every alliance member as an owner.
4. Keep **explicitly sourced facts** separate from **inference**.
5. If a relationship is only implied by a tender quote or by shared personnel, mark it as provisional.
...
- **Our People's Trust -> gtd healthcare**
  GTD says the trust is its single shareholder.

- **Northern Health GPPO -> MPCP**
  MPCP says NHGPPO is one of its three shareholder federations.

- **Primary Care Manchester -> MPCP**
  MPCP says PCM is one of its three shareholder federations.

- **South Manchester GP Federation -> MPCP**
  MPCP says SMGPF is one of its three shareholder federations.

- **Central Manchester practices -> Primary Care Manchester**
  PCM/CMN says local practices are its shareholders.

- **South Manchester practices -> South Manchester GP Federation**
  SMGPF says all South Manchester practices are its shareholders.

- **North Manchester practices -> Northern Health GPPO**
  NHGPPO says it is a membership organisation supporting the north-Manchester practice base.

### Collaboration / alliance layer

- **gtd healthcare <-> GMUPCA**
  GTD is one of the alliance partners.

- **Mastercall <-> GMUPCA**
  Mastercall is one of the alliance partners.

- **Bardoc <-> GMUPCA**
  Bardoc is one of the alliance partners.

- **SPCT <-> GMUPCA**
  SPCT publicly says it is a member; GMUPCA lists it as a partner.

- **Wigan GP Alliance <-> GMUPCA**
  GMUPCA lists it as a partner / associate member at the alliance layer.
...
- **Pressure source**
  Who or what creates the pressure.
- **Who feels it**
  Which organisations or decision-makers sit under it.
- **Operational effect**
  What it tends to change in service design, contract behaviour or public messaging.
- **Patient-facing risk**
  What a patient or resident may actually experience when that pressure is handled badly.
- **Visible signals**
  The public-source facts that justify showing that pressure on the page.
...
1. A provider is pushed to show scale, resilience and integration.
2. That pushes service design toward standardisation, triage and central routing.
3. Workforce and inequality pressures then make those systems harder for some patients to navigate.
4. Social-value and reputation pressures then shape how the organisation explains that model in public.
...
1. **Ownership / legal form**
   - trust, CIC, LLP, company limited by guarantee, membership body, etc.
2. **Manchester federation structure**
   - NHGPPO, PCM, SMGPF, MPCP
3. **Urgent-care alliance structure**
   - GMUPCA and its member organisations
4. **Practice-management / catchment competitor layer**
